...
public class Chlodniczy:Kontener
{
    ...
    public Chlodniczy(int masaLadunku, int wysokosc, int wagaWlasna, int glebokosc, string numerSeryjny, int maksymalnaLadownosc, string rodzajProduktu, int temperatura) : base(masaLadunku, wysokosc, wagaWlasna, glebokosc, numerSeryjny, maksymalnaLadownosc)
    {
